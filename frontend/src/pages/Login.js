...
const Login = () => {
  ...
  return (
    <div className="h-full w-full flex items-center justify-center bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      {/* Animated Background */}
